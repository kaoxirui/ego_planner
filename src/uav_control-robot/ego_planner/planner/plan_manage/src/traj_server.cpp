...
ros::Publisher pose_cmd_pub;//px4
...
//    return;
  ...
  pose_cmd.pose.orientation.z = sin(yaw_yawdot.first/2);
  pose_cmd.pose.orientation.w = cos(yaw_yawdot.first/2);

  // cout<<"publish pose"<<endl;
  ROS_WARN_THROTTLE(1.5, "Send uav control. ");
...
int main(int argc, char **argv)
{
  ...
  pose_cmd_pub = nh.advertise<geometry_msgs::PoseStamped>("/pose_cmd", 50);//px4 直接接收
